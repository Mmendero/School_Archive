    ...
    <div class="row">
      <div class="col">
        <div class="frontpage-card">
          <div class="card">
            <div class="card-body">
                <h5 class="card-title">Enter the Candy to add to Inventory</h5>
                
                <form action="" method="post">
                    <div class="form-group">
                      <label for="p_id">ProductID</label>
                      <input type="text" class="form-control" name="p_id" placeholder="UniqueID" aria-describedby="p_name">
                    </div>
    
                    <div class="form-group">
                      <label for="p_name">Name</label>
                      <input type="text" class="form-control" name="p_name" placeholder="Product Name"aria-describedby="p_id">
                    </div>
    
                    <div class="form-group">
                      <label for="p_brand">Brand/Manufacturer</label>
                      <input type="text" class="form-control" name="p_brand" placeholder="Manufacturer" aria-describedby="p_brand">
                    </div>
    
                    <div class="form-group">
                      <label for="p_price">Price</label>
                      <input type="number" step="any" class="form-control" name="p_price" placeholder="Price per unit (Double)" aria-describedby="p_category">
                    </div>

                    <div class="form-group">
                      <label for="p_stock">Stock</label>
                      <input type="number" class="form-control" name="p_stock" placeholder="How much to add" aria-describedby="p_category">
                    </div>

                    <div class="form-group">
                      <label for="p_category">Category</label>
                      <input type="text" class="form-control" name="p_category" placeholder="Product Category" aria-describedby="p_category">
                    </div>
                    
                    <input type="hidden" value="NONE" name="p_description" placeholder="Product Description" aria-describedby="p_category">
